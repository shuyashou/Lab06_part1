...
class raceDemogData {
  public:
      ...
      void initialize(){
        FirstNationCount=0; //Native American/First Nation
        AsianCount=0; //Asian American
        BlackCount=0; //African American/Black
        LatinxCount=0; //Hispanic/Latinx
        HIPacificIsleCount=0; //Hawaiian Pacific Islander
        MultiRaceCount=0; //Multi-racial
        WhiteCount=0; //White (includes Hispanic)
        WhiteNHCount=0; //White non-Hispanic
        otherCount=0; //Other category used for other data sources
        communityCount=0;
      }
